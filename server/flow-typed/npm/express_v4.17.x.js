...
declare type express$Middleware<Req: express$Request = express$Request, Res: express$Response = express$Response> =
   | ((req: Req, res: Res, next: express$NextFunction) => mixed)
   | ((error: Error, req: Req, res: Res, next: express$NextFunction) => mixed);

declare interface express$RouteMethodType<T, Req: express$Request = express$Request, Res: express$Response = express$Response> {
   (middleware: express$Middleware<Req, Res>): T;
   (...middleware: Array<express$Middleware<Req, Res>>): T;
   (path: express$Path | $ReadOnlyArray<express$Path>, ...middleware: Array<express$Middleware<Req, Res>>): T;
}

declare class express$Route<Req: express$Request = express$Request, Res: express$Response = express$Response> {
...
declare class express$Router<Req: express$Request = express$Request, Res: express$Response = express$Response> extends express$Route<
   Req,
   Res
> {
   constructor(options?: express$RouterOptions): void;
   route(path: string): express$Route<Req, Res>;
   static <Req2: express$Request, Res2: express$Response>(options?: express$RouterOptions): express$Router<Req2, Res2>;
   use(middleware: express$Middleware<Req, Res>): this;
   use(...middleware: Array<express$Middleware<Req, Res>>): this;
   use(path: express$Path | $ReadOnlyArray<express$Path>, ...middleware: Array<express$Middleware<Req, Res>>): this;
   ...
   param(param: string, callback: (req: Req, res: Res, next: express$NextFunction, value: string, paramName: string) => mixed): void;
...
declare class express$Application<Req: express$Request = express$Request, Res: express$Response = express$Response> extends express$Router<
   Req,
   Res
...
declare module 'express' {
   ...
   declare export type Middleware<Req: express$Request = express$Request, Res: express$Response = express$Response> = express$Middleware<
      Req,
      Res
   >;
   ...
   declare export type $Application<Req: express$Request = express$Request, Res: express$Response = express$Response> = express$Application<
      Req,
      Res
   >;
