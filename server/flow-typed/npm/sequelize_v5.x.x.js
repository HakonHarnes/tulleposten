// flow-typed signature: 69ad8159c459e4f97f8646f72ddf2051
// flow-typed version: c6154227d1/sequelize_v4.x.x/flow_>=v0.104.x
...
declare module 'sequelize' {
  ...
  */
   declare export type HasOneSetOne<TInstance: Model<any>, TInstancePrimaryKey> = {
      ...
      (
         ...
         options?: HasOneSetOneOptions & HasOneGetOneOptions & InstanceSaveOptions<any>
      ): Promise<void>,
      ...
   };
  ...
  */
   declare export type HasManySetMany<TInstance: Model<any>, TInstancePrimaryKey> = {
       ...
       */
      (
         newAssociations: ?$ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: HasManySetManyOptions & AnyFindOptions & InstanceUpdateOptions<any>
      ): Promise<void>,
      ...
   };
  ...
  */
   declare export type HasManyAddMany<TInstance: Model<any>, TInstancePrimaryKey> = {
      ...
      (
         newAssociations: $ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: HasManyAddManyOptions & InstanceUpdateOptions<any>
      ): Promise<void>,
      ...
   };
  ...
  */
   declare export type HasManyRemoveMany<TInstance: Model<any>, TInstancePrimaryKey> = {
       ...
       */
      (
         oldAssociateds?: $ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: HasManyRemoveManyOptions & InstanceUpdateOptions<any>
      ): Promise<void>,
      ...
   };
  ...
  */
   declare export type BelongsToManySetMany<TInstance: Model<any>, TInstancePrimaryKey, TJoinTableAttributes> = {
      ...
      (
         newAssociations: ?$ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: BelongsToManySetManyOptions &
            AnyFindOptions &
  ...
  */
   declare export type BelongsToManyAddMany<TInstance: Model<any>, TInstancePrimaryKey, TJoinTableAttributes> = {
      ...
      (
         newAssociations: $ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: BelongsToManyAddManyOptions &
            AnyFindOptions &
            BulkCreateOptions<any> &
            InstanceUpdateOptions<any> &
            InstanceDestroyOptions & { through?: TJoinTableAttributes, ... }
  ...
  */
   declare export type BelongsToManyAddOne<TInstance: Model<any>, TInstancePrimaryKey, TJoinTableAttributes> = {
      ...
      (
         newAssociation: TInstance | TInstancePrimaryKey,
         options?: BelongsToManyAddOneOptions &
            AnyFindOptions &
            BulkCreateOptions<any> &
            InstanceUpdateOptions<any> &
            InstanceDestroyOptions & { through?: TJoinTableAttributes, ... }
  ...
  */
   declare export type BelongsToManyCreateOne<TInitAttributes, TInstance: Model<any, TInitAttributes>, TJoinTableAttributes> = {
       ...
       */
      (
         values?: TInitAttributes,
         options?: BelongsToManyCreateOneOptions & CreateOptions<any> & { through?: TJoinTableAttributes, ... }
      ): Promise<TInstance>,
      ...
   };
  ...
  */
   declare export type BelongsToManyRemoveMany<TInstance: Model<any>, TInstancePrimaryKey> = {
      ...
      (
         oldAssociateds?: $ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: BelongsToManyRemoveManyOptions & InstanceDestroyOptions
      ): Promise<void>,
      ...
   };
  ...
  */
   declare export type BelongsToManyHasMany<TInstance: Model<any>, TInstancePrimaryKey> = {
       ...
       */
      (
         targets: $ReadOnlyArray<TInstance | TInstancePrimaryKey>,
         options?: BelongsToManyHasManyOptions & BelongsToManyGetManyOptions
      ): Promise<boolean>,
      ...
   };
  ...
  */
   ...
   */
    ...
    */
   declare export type AssociationScope = { [scopeName: string]: any, ... };
   ...
   */
   ...
   > extends Association<Source, Target> {
      ...
      has<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
         options?: FindOptions<TargetAttributes>
      ): Promise<boolean>;
      set<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
         options?: FindOptions<TargetAttributes> & UpdateRelatedOptions<TargetAttributes>
      ): Promise<Source>;
      add<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
         options?: UpdateRelatedOptions<TargetAttributes>
      ): Promise<Source>;
      remove<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
   ...
   > extends Association<Source, Target> {
      ...
      paired?: BelongsToMany<
         TargetAttributes,
         TargetInitAttributes,
         Target,
         SourceAttributes,
         SourceInitAttributes,
         Source,
         ThroughAttributes,
         Through
      >;
      ...
      set<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
         options?: FindOptions<TargetAttributes> & UpdateRelatedOptions<TargetAttributes> & DestroyOptions
      ): Promise<Array<any>>;
      add<PrimaryKey>(
         sourceInstance: Source,
         targetInstances: ArrayOrElement<PrimaryKey | Target>,
   ...
   */
   ...
   declare type DataTypeVirtual = DataTypeAbstract &
      typeof DataTypeVirtualClass & { (subtype: DataTypeAbstract, requireAttributes?: Array<string>): DataTypeVirtual, ... };
  ...
  */
   ...
   declare export class ValidationError extends BaseError {
       ...
       */
      constructor(message: string, errors?: ValidationErrorItem[]): ValidationError;
   ...
   declare export class ValidationErrorItem extends BaseError {
       ...
       */
      constructor(message: string, type: string, path: string, value: string): ValidationErrorItem;
  ...
  */
   ...
   declare export type InstanceUpdateOptions<TAttributes> = {
      ...
      where?: WhereOptions,
      ...
   } & InstanceSaveOptions<TAttributes> &
      InstanceSetOptions;
  ...
  */
    ...
    */
   declare export type WhereOptions =
      | WhereAttributeHash
      | AndOperator
      | OrOperator
      | where
      | fn
      | $ReadOnlyArray<string | number | AndOperator | OrOperator>;
    ...
    * _PG only_
    */
   declare export type AnyOperator = { $any: $ReadOnlyArray<string | number>, ... };

   /** Undocumented? */
   declare export type AllOperator = { $all: $ReadOnlyArray<string | number>, ... };
   ...
   declare export type OrOperator = {
      [$or: Symbol | '$or']:
         | WhereOperators
         | WhereAttributeHash
         | $ReadOnlyArray<Array<string> | Array<number> | WhereOperators | WhereAttributeHash | where | AndOperator>,
      ...
   };
   ...
   declare export type AndOperator = {
      [$and: Symbol | '$and']:
         | WhereOperators
         | WhereAttributeHash
         | $ReadOnlyArray<Array<string> | Array<number> | WhereOperators | WhereAttributeHash | where | OrOperator>,
      ...
   };
   ...
   declare export type IncludeOptions<TAttributes, TInstance: Model<TAttributes>> = {
       ...
       */
      attributes?:
         | FindOptionsAttributesArray<TAttributes>
         | {
   ...
   declare export type FindOptionsAttributesArray<TAttributes> = Array<
      $Keys<TAttributes> | literal | [fn, string] | [cast, string] | [literal, string] | [$Keys<TAttributes>, string] | fn | cast
   >;
  ...
  */
    ...
    */
      static addScope(name: string, scope: AnyFindOptions | ((...args: Array<any>) => AnyFindOptions), options?: AddScopeOptions): void;
    ...
    */
      static scope(options?: string | ScopeOptions | $ReadOnlyArray<string | ScopeOptions>): Class<this>;
     ...
     * @see  {Sequelize#query}
    */
      static findAll<TCustomAttributes>(options?: FindOptions<TAttributes & TCustomAttributes>): Promise<this[]>;
       ...
       * instance.
       */
      static findOne<TCustomAttributes>(options?: FindOptions<TAttributes & TCustomAttributes>): Promise<?this>;
    ...
    */
       ...
       */
      static findOrBuild(options: FindOrInitializeOptions<TInitAttributes>): Promise<[this, boolean]>;
    ...
    */
      static findOrCreate(options: FindOrInitializeOptions<TInitAttributes>): Promise<[this, boolean]>;
      ...
      static findCreateFind<TCustomAttributes>(
         options: FindCreateFindOptions<TInitAttributes & TCustomAttributes>
      ): Promise<[this, boolean]>;
    ...
    */
      static bulkCreate(records: TInitAttributes[], options?: BulkCreateOptions<TAttributes>): Promise<this[]>;
    ...
    */
      static update(values: $Shape<TAttributes>, options: UpdateOptions<TAttributes>): Promise<[number, this[]]>;
     ...
     */
       ...
       */
      static beforeValidate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterValidate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static validationFailed(name: string, fn: AsyncFn3<this, Object, ValidationError>): void;
       ...
       */
      static beforeCreate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      static afterCreate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static beforeDestroy(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterDestroy(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static beforeUpdate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterUpdate(name: string, fn: AsyncFn2<this, Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      static beforeUpsert(name: string, fn: AsyncFn2<TInitAttributes, Object>): void;
       ...
       */
      static afterUpsert(name: string, fn: AsyncFn2<boolean | [this, boolean], Object>): void;
       ...
       */
      static beforeBulkCreate(name: string, fn: AsyncFn2<this[], Object>): void;
       ...
       */
      static afterBulkCreate(name: string, fn: AsyncFn2<this[], Object>): void;
       ...
       */
      static afterFind(name: string, AsyncFn2<this | this[], Object>): void;
      static afterFind(AsyncFn2<this | this[], Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      static beforeDefine(name: string, fn: AsyncFn2<DefineAttributes, Object>): void;
     ...
     */
      ...
      ): HasOne<this, TargetAttributes, TargetInitAttributes, Target>;
     ...
     */
      ...
      ): BelongsTo<this, TargetAttributes, TargetInitAttributes, Target>;
     ...
     */
      ...
      ): HasMany<this, TargetAttributes, TargetInitAttributes, Target>;
     ...
     */
      ...
      ): BelongsToMany<TAttributes, TInitAttributes, this, TargetAttributes, TargetInitAttributes, Target, ThroughAttributes, Through>;
     ...
     */
      validate(options?: { skip?: $Keys<TAttributes>[], ... }): Promise<ValidationError>;

      /**
       * This is the same as calling `set` and then calling `save`.
       */
      update(key: $Keys<TAttributes>, value: any, options?: InstanceUpdateOptions<TAttributes>): Promise<this>;
  ...
  */
    ...
    */
       ...
       */
      insert(instance: Model<any>, tableName: string, values: Object, options?: QueryOptions): Promise<Object>;

      /**
       * Inserts or Updates a record in the database
       */
      upsert(tableName: string, values: Object, updateValues: Object, model: Class<Model<any>>, options?: QueryOptions): Promise<Object>;
       ...
       * Updates a row
       */
      update(instance: Model<any>, tableName: string, values: Object, identifier: Object, options?: QueryOptions): Promise<Object>;
       ...
       * Deletes a row
       */
      delete(instance: Model<any>, tableName: string, identifier: Object, options?: QueryOptions): Promise<Object>;

      /**
       * Deletes multiple rows at once
       */
      bulkDelete(tableName: string, identifier: Object, options?: QueryOptions, model?: Class<Model<any>>): Promise<Object>;

      /**
       * Returns selected rows
       */
      select(model: Class<Model<any>>, tableName: string, options?: QueryOptions): Promise<Object[]>;

      /**
       * Increments a row value
       */
      increment(instance: Model<any>, tableName: string, values: Object, identifier: Object, options?: QueryOptions): Promise<Object>;
   ...
   */
    ...
    */
   declare export type DefineAttributes = { [name: string]: string | DataTypeAbstract | DefineAttributeColumnOptions, ... };
  ...
  */
   ...
   */
    ...
    * @see  DefineOptions
    */
   declare export type DefineGetterMethodsOptions = { [name: string]: () => any, ... };

   /**
    * Interface for setterMethods in DefineOptions
    * @see  DefineOptions
    */
   declare export type DefineSetterMethodsOptions = { [name: string]: (val: any) => void, ... };

   /**
    * Interface for Define Scope Options
    * @see  DefineOptions
    */
   declare export type DefineScopeOptions = { [scopeName: string]: AnyFindOptions | ((...args: Array<any>) => AnyFindOptions), ... };
   ...
   */
   ...
   declare export type OperatorsAliases = { [key: string]: Symbol, ... };
   ...
   */
   ...
   declare export type QueryOptionsTransactionRequired = { transaction: Transaction, ... };

   declare export type ModelsHashInterface = { [name: string]: Class<Model<any>>, ... };
  ...
  */
   declare export default class Sequelize {
     ...
     */
       ...
       * @param fn A callback function that is called with instance, options
       */
      static beforeValidate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterValidate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static validationFailed(name: string, fn: AsyncFn3<Model<any>, Object, ValidationError>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      static beforeCreate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      static afterCreate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static beforeDestroy(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterDestroy(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static beforeUpdate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      static afterUpdate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instances, options
       */
      static beforeBulkCreate(name: string, fn: AsyncFn2<Model<any>[], Object>): void;
       ...
       * @name  afterBulkCreate
       */
      static afterBulkCreate(name: string, fn: AsyncFn2<Model<any>[], Object>): void;
       ...
       * @param fn A callback function that is called with instance(s), options
       */
      static afterFind(name: string, AsyncFn2<Model<any> | Model<any>[], Object>): void;
      static afterFind(AsyncFn2<Model<any> | Model<any>[], Object>): void;
     ...
     */
       ...
       * @param fn A callback function that is called with instance, options
       */
      beforeValidate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      afterValidate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      validationFailed(name: string, fn: AsyncFn3<Model<any>, Object, ValidationError>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      beforeCreate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      afterCreate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      beforeDestroy(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      afterDestroy(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      beforeUpdate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instance, options
       */
      afterUpdate(name: string, fn: AsyncFn2<Model<any>, Object>): void;
       ...
       * @param fn A callback function that is called with instances, options
       */
      beforeBulkCreate(name: string, fn: AsyncFn2<Model<any>[], Object>): void;
       ...
       * @name  afterBulkCreate
       */
      afterBulkCreate(name: string, fn: AsyncFn2<Model<any>[], Object>): void;
       ...
       * @param fn A callback function that is called with instance(s), options
       */
      afterFind(name: string, AsyncFn2<Model<any> | Model<any>[], Object>): void;
      afterFind(AsyncFn2<Model<any> | Model<any>[], Object>): void;
       ...
       * @param fn A callback function that is called with attributes, options
       */
      beforeDefine(name: string, fn: AsyncFn2<DefineAttributes, Object>): void;
    ...
    */
      import<ModelClass: Class<Model<any>>>(
         path: string,
         defineFunction?: (sequelize: Sequelize, dataTypes: DataTypes) => ModelClass
      ): ModelClass;
    ...
    */
      ...
      transaction<T, Fn: TransactionAutoCallback<T>>(options: TransactionOptions, autoCallback: Fn): Promise<T>;
  ...
  */
   ...
   declare export type TransactionIsolationLevel =
